...
public class TicketManagementService {
    ...
    public void createTicket(String id, String title, String description, models.Priority priority, String assignee) {
        DevelopmentTicket newTicket = new DevelopmentTicket(id, title, description, priority, assignee);
