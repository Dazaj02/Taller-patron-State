...
public class TicketController {
    ...
    public String createTicket(String id, String title, String description, models.Priority priority, String assignee) {
        ...
        service.createTicket(id, title, description, priority, assignee);
